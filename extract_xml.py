...
def extract_drawio_xml(png_path):
    ...
    with open('/home/thainv/workspace/sports-booking-platform/extracted_drawio.xml', 'w', encoding='utf-8') as out:
        out.write(mxfile)
    print("Saved metadata to /home/thainv/workspace/sports-booking-platform/extracted_drawio.xml")
